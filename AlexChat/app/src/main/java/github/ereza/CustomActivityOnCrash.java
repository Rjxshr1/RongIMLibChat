...
public final class CustomActivityOnCrash {
    ...
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "github.ereza.EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = "github.ereza.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "github.ereza.EXTRA_STACK_TRACE";

    //General constants
    private final static String TAG = "CustomActivityOnCrash";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "github.ereza.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "github.ereza.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "github.ereza";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="github.ereza.RESTART" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="github.ereza.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="github.ereza.ERROR" />,
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="github.ereza.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
